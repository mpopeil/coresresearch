...
While he will make any and all efforts to maintain anonymity (i.e. your identity will protected, if at all possible), he cannot therefore promise that any reports will be maintained as confidential.  As described below in the [reporting options](#reporting-guidelines-and-options), anonymous reporting options are available to those for whom anonymity is a significant priority.
